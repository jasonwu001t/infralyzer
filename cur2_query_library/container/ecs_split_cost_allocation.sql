-- Amazon ECS Split Cost Allocation Data Analysis
-- Description: ECS split cost allocation for container-level cost and resource consumption
-- Output: Split usage, split cost, and unused cost by resource and parent resource
...
WHERE 
  ...
  AND line_item_operation LIKE 'ECSTask%'
