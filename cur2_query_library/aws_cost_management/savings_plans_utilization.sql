...
-- Description: Active Savings Plan ARNs and their utilization for analysis
-- Output: Detailed savings plan metrics including utilization percentages and commitment details
-- Source: AWS CUR Query Library - AWS Cost Management section
-- Note: Simplified for Polars compatibility - date parsing functions adjusted
